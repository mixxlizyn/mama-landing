...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      title: "ДПДГ терапия",
      description:
        "Эффективный метод работы с травмами и посттравматическими стрессовыми расстройствами через двусторонную стимуляцию мозга.",
      image: emdrTherapy,
      duration: "60 минут",
      price: "от 4500 ₽",
      color: "calm",
            ...
            >
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between items-start">
                  <h3
                    className={`text-2xl font-semibold text-${service.color}`}
                  >
                    {service.title}
                  </h3>
                ...
                <div className="pt-2">
                  <Button
                    ...
                    className={`w-full bg-gradient-to-r from-${
                      ...
                      service.color === "healing" ? "calm" : "healing"
